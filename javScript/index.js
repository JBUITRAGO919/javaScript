...
var x=10;
var X=11; /**variable diferente a la x minuscula */
...
/**las cadenas de texto pueden ser cualquier texto que aparece entre comillas, pueden ser 
 * simples o dobles 
 */

 var nombre='pedro';
 var text="Mi nombre es Javier Buitrago";
 console.log(nombre)
 console.log(text)
 ...
 var text =" hola a todos!' \ soy Javier un estudiante que aprende a programar.\ ";
...
var q=1;
var r=33
r/=p+=q; /**esta operación quedaria r=r/(p+q) */
console.log(r)


var t=12
var u=5
t%=u /**esta operación quedaria t=t%u */
console.log(t)
...
function sayHello(name){
    alert("Hola señor: " + name);
}

sayHello("Javier Buitrago");    
/**alerta = hola javier buitrago */
...
/**Ahora sin utilizar los parentesis */
let {a3, b3} = {a3: 'Hello', b3};
console.console.log((a3 + b3));
